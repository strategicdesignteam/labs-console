...
class CreateUserForm extends React.Component {
  ...
  handleChange = (e, prop) => {
    const o = Object.assign({}, this.state.newUser);
  ...
  render() {
    return (
      <form className="form-horizontal" role="form">
        ...
        <div className="form-group">
          <label htmlFor="email" className="col-sm-2 control-label required-pf">
            Email
          </label>
          <div className="col-sm-10">
            <input type="email"
        ...
        <div className="form-group">
          <label htmlFor="sshkey" className="col-sm-2 control-label">
            SSH Public Key
          </label>
          <div className="col-sm-10">
            <textarea className="form-control"
              ...
              onChange={(e) => {
                this.handleChange(e, 'ssh_public_key');
              }}/>
          </div>
        </div>
