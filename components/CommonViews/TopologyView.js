...
class TopologyView extends React.Component {
  render() {
    const {
      ...
      handleStageMoved,
      handleAddStage,
      handleAddStageProject,
      handleDeleteStageProject,
      handleCreateProject,
      handleProjectEdit,
      handleProjectDelete,
      startBuildModal,
    ...
    content.push(
      <StagesCanvasManager projects={projects}
        stages={stages}
        ...
        <Modal id={startBuildModalId}
          ...
          <div className="text-center">
            ...
            <div className={c.spacing}>
              <p>
                The following stages have projects with incomplete infrastructure:
              </p>
            ...
            <div className={c.spacing}>
              <button className="btn btn-primary btn-lg" onClick={cancelStart}>
                OK
              </button>
            </div>
          </div>
      ...
      modal = (
        <Modal id={startBuildModalId}
          ...
          <div className="text-center">
            ...
            <p>Are you sure?</p>
            <div className={c.spacing}>
              <button className="btn btn-default btn-lg" onClick={cancelStart}>
                No
              </button>
              &nbsp;
              <button className="btn btn-primary btn-lg" onClick={startBuild}>
                Yes
              </button>
            </div>
          </div>
