                    ...
                    <div className="list-group-item-text">
                      {(() => {
                        ...
                        if (
                          ...
                          content.push(
                            moment(build.datetime_started).fromNow()
                          );
                        }
                        return content;
                      })()}
              ...
              <div className="row">
                ...
                <div className="col-xs-12 col-sm-6 col-md-4">
                  <dl className="dl-horizontal">
                    <dt>Started</dt>
                    <dd>
                      {moment(build.datetime_started).format(
                    ...
                    {build.status !== constants.ANSIBLE_JOB_STATUS.PENDING &&
                      <dd>
                        {moment(build.datetime_completed).format(
                          'MMM Do YYYY, h:mm:ss a'
                        )}
                      </dd>}
                  </dl>
                ...
                <div className="col-xs-12 col-sm-6 col-md-4">
                  <dl className="dl-horizontal">
                    <dt>Status</dt>
                    <dd className={cx({
                      'text-danger': build.status ===
                          constants.ANSIBLE_JOB_STATUS.FAILED ||
                          build.status ===
                            constants.ANSIBLE_JOB_STATUS.CANCELLED,
                      'text-success': build.status ===
                          constants.ANSIBLE_JOB_STATUS.SUCCESSFUL
                    })}>
                      {build.status}
                    </dd>
