...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RedHatOpenInnovationLabsApi.ReencryptRoute = factory(root.RedHatOpenInnovationLabsApi.ApiClient, root.RedHatOpenInnovationLabsApi.Route, root.RedHatOpenInnovationLabsApi.Service);
  }
  ...
  /**
   * The ReencryptRoute model module.
   * @module model/ReencryptRoute
   * @version 0.3.0-alpha
   */

  /**
   * Constructs a new <code>ReencryptRoute</code>.
   * @alias module:model/ReencryptRoute
   * @class
  ...
  /**
   * Constructs a <code>ReencryptRoute</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReencryptRoute} obj Optional instance to populate.
   * @return {module:model/ReencryptRoute} The populated <code>ReencryptRoute</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dest_ca_cert')) {
        obj['dest_ca_cert'] = ApiClient.convertToType(data['dest_ca_cert'], 'String');
      }
  ...
  /**
   * @member {String} dest_ca_cert
   */
  exports.prototype['dest_ca_cert'] = undefined;
  /**
