(function(root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    module.exports = factory(require('../ApiClient'), require('../model/Infrastructure'), require('../model/ErrorModel'));
  } else {
    // Browser globals (root is window)
    if (!root.RedHatOpenInnovationLabsConsoleApi) {
      root.RedHatOpenInnovationLabsConsoleApi = {};
    }
    root.RedHatOpenInnovationLabsConsoleApi.InfrastructureApi = factory(root.RedHatOpenInnovationLabsConsoleApi.ApiClient, root.RedHatOpenInnovationLabsConsoleApi.Infrastructure, root.RedHatOpenInnovationLabsConsoleApi.ErrorModel);
  }
}(this, function(ApiClient, Infrastructure, ErrorModel) {
  'use strict';
