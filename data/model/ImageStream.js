...
(function(root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.RedHatOpenInnovationLabsConsoleApi.ImageStream = factory(root.RedHatOpenInnovationLabsConsoleApi.ApiClient);
  }
  ...
  /**
   * The ImageStream model module.
   * @module model/ImageStream
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>ImageStream</code>.
   * @alias module:model/ImageStream
   * @class
   */
  ...
  /**
   * Constructs a <code>ImageStream</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ImageStream} obj Optional instance to populate.
   * @return {module:model/ImageStream} The populated <code>ImageStream</code> instance.
   */
   ...
   */
  exports.prototype['image_tags'] = undefined;
